    ...
    <div style=" padding: 0px 24px 27px 57px; clear: both;">
        ...
        <div style="width: 100%; display: block">
            ...
            <h2 style="white-space: pre-line; line-height: 1.8; color:#2c3e50;margin: 0px auto 20px auto;">
                You have been added as an instructor on EC-Council Learning!
            </h2>
            ...
            <p>
                <b>
                    @if($user['type'] == \App\Domains\User\Enum\UserType::USER)
                        <a class="url-login" href="{{ config('user.user_website') . '/login' }}">Login As User</a>
                    @else
                        <a class="url-login" href="{{ config('user.instructor_dashboard') . '/login' }}">Login as Instructor</a>
                    @endif
                </b>
            </p>
