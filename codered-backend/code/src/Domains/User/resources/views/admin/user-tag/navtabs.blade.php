<ul class="nav">
    ...
    <a href="{{ url($admin_base_url . "/user-tag") }}" id="nav-tab" class="nav-item tabs-border text-decoration-none bg-white px-4 py-2">
    ...
    <a href="{{ url($admin_base_url . "/payout") }}" id="nav-tab" class="nav-item tabs-border text-decoration-none bg-white px-4 py-2">
        <span data-link="{{ url($admin_base_url . "/payout") }}" class="fs-1 text-black px-1">Payout</span>
    </a>
    @endpermitted

    @permitted(\App\Domains\User\Rules\PayoutPermission::PAYOUT_INDEX)
    <a href="{{ url($admin_base_url . "/payout/export-reports") }}" id="nav-tab" class="nav-item tabs-border top-right-border-radius text-decoration-none bg-white px-4 py-2">
        <span data-link="{{ url($admin_base_url . "/payout/export-reports") }}" class="fs-1 text-black px-1">Reports</span>
    </a>
    @endpermitted
