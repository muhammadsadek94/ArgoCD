            ...
            <div class="row align-item-end justify-content-end pr-2">
                <div class="col-lg-2 col-12">
                    @include('admin.components.inputs.select', [
                        ...
                        'form_options' => ['placeholder' => 'Select Status'],
                        'select_options' => App\Domains\User\Enum\PayoutStatus::getStatusList(),
                    ])
                </div>
                ...
                <div class="col-lg-2 col-12">
                    @include('admin.components.inputs.text', [
                        'name' => 'search',
                        'label' => ' Search ',
                        'form_options' => ['placeholder' => 'Search'],
                        'cols' => 'col-12 col-xl-12 col-md-12 col-xs-12',
                    ])
                </div>

                <div class="col-lg-2 col-12 d-flex align-items-center mt-2">
                    <button type="submit" style="border-radius: 6px; border-color:#3DC47E"
