...
namespace App\Domains\User\Features\Api\V1\User\ForgetPassword;

use App\Domains\User\Http\Requests\Api\V1\User\ValidateForgetPasswordCodeRequest;
use App\Domains\User\Jobs\Api\V1\User\ForgetPassword\ValidateCodeJob;
