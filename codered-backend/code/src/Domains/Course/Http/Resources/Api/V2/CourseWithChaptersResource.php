...
use App\Domains\Course\Http\Resources\Api\V2\Chapter\ChaptersWithoutLessonsResource;
use App\Domains\Uploads\Http\Resources\FileResource;
use INTCore\OneARTFoundation\Http\JsonResource;

class CourseWithChaptersResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'course_syllabus'       => ChaptersWithoutLessonsResource::collection($this->chapters()->has('lessons')->active()->get()),
        ];
    }
