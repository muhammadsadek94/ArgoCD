...
{{--    @include('admin.components.inputs.text', [
    ...
    @include('admin.components.inputs.select', [
        'name' => 'challenge_id',
        'label' => 'Competition',
        'form_options' => ['placeholder' => 'Select Challenge'],
        'select_options' => $challenges,
        'cols' => 'col-12 col-md-3',
    ])
    ...
    @include('admin.components.inputs.select-multiple-tags', [
        ...
        'form_options' => [''],
        'cols' => 'col-12',
        'select_options' => $row->course_tags ?? [],
        'value' => $row->course_tags ?? [],
    ])


    <hr>

    @if (!isset($row)|| !$row->microdegree || !$row->microdegree->faq)
    ...
    @if (!isset($row) || !$row->microdegree || !$row->microdegree->skills_covered)
    ...
    @if (!isset($row) || !$row->microdegree || !$row->microdegree->key_features)
    ...
    @if (!isset($row) || !$row->microdegree || !$row->microdegree->project)
