...
use App\Domains\Brightcove\API\Exception\AuthenticationException;
use App\Domains\Brightcove\API\Exception\APIException;
use App\Domains\Brightcove\Constants;
use App\Domains\Brightcove\Item\ObjectInterface;
...
class Client
{
    ...
    {
        [$code, $response] = self::HTTPRequest('POST', 'https://oauth.brightcove.com/v3/access_token',
...
//        dd([
//            'url' => "https://{$api_type}.api.brightcove.com/v{$api_version}/accounts/{$account}{$endpoint}",
//            'method' => $method,
//            'body' => json_encode($post->patchJSON()),
//            'json' => json_encode($post->postJSON()),
//            'access_token' => $this->access_token
//        ]);

        //dd("https://{$api_type}.api.brightcove.com/v{$api_version}/accounts/{$account}{$endpoint}");
        $total_requests = 0;
        do {
            [$code, $res] = self::HTTPRequest($method,
