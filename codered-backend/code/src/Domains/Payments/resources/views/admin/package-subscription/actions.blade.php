...
@if(isset($permitted_actions) && ($permitted_actions['edit'] == null || is_permitted($permitted_actions['create'])))
    <a data-toggle="tooltip" data-placement="top" title="Duplicate" href="{{ url(Constants::ADMIN_BASE_URL . "/package-subscription/duplicate?package_subscription={$row->id}") }}" class="btn btn-icon btn-sm mr-1">
