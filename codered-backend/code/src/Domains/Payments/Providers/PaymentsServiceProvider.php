...
use App\Domains\Payments\Providers\RouteServiceProvider;
use Illuminate\Translation\TranslationServiceProvider;

class PaymentsServiceProvider extends ServiceProvider
{

    private $configPath = __DIR__ . '/../config/payments.php';
     ...
     *
     * Previous usage:
     * php artisan migrate --path=src/Domains/Payments/database/migrations
     * Now:
     * php artisan migrate
     *
     * @return void
    ...
    /**
    * Register the Payments service provider.
    *
    * @return void
    */
    ...
    /**
     * Register the Payments service resource namespaces.
     *
     * @return void
     */
    protected function registerResources()
    {
        ...
        $this->publishes([
            $this->configPath => config_path('payments.php'),
        ], 'config');
        ...
        // View::addNamespace('payments', base_path('resources/views/vendor/payments'));
