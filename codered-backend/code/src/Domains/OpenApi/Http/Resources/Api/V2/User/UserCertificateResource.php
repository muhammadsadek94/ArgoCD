...
use App\Domains\User\Http\Resources\Api\V2\User\UserBasicInfoResource;
...
class UserCertificateResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'instructor'  => $this->course ? new UserBasicInfoResource($this->course->instructors()->first()) : 'Course Deleted',
