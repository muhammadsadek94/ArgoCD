...
class FcmMessage
{
     ...
     * @return $this
     */
    public function setSettings(NotificationSetting $setting)
    {
     ...
     * @return FcmMessage
     */
    public function setMessage(NotificationMessage $message)
    {
     ...
     * @return $this
     */
    public function setData(CustomData $data = null)
    {
        $this->data = is_null($data) ? $data : $data->getData();
     ...
     * @return string
     */
    public function formatData($language)
    {
        $payload = [
        ...
        $payload['notification'] = $this->generateNotificationMessage($language);
    ...
    private function generateNotificationMessage($language)
    {
        $settings = $this->settings;
        $message = $this->message->getMessage($language);
        $notification = array_merge($settings, $message);
        return $notification;
    }
}
