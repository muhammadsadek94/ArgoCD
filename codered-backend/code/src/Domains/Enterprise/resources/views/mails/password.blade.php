...
<div style="margin: 0 auto;">
    ...
    <div style=" padding: 0px 24px 27px 57px; clear: both;">
        <div style="text-align:left;">
            <img src="{{ asset('assets/imgs/logo.png') }}" style="height: 40px;  margin:27px auto 0px auto">
        </div>
        <div style="width: 100%; display: block">
            ...
            <p style="color:#2c3e50;">
                ...
                <p>
                    <b>
                        <a class="url-login" href="{{ config('enterprise.urls.enterprise_dashboard') . '/login' }}">Login</a>
                    </b>
                </p>
