...
use DB;
class EnterpriseLearnPathsDetailsReportResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            "avg_progress"      => $this->progress($this),
            "courses"           => BasicEnterpriseLearnPathCoursesWithProgressResource::collection($this->courses),
            "users"             => BasicEnterpriseUserDetailsResource::collection($this->users())
    ...
    public function progress($learnpath)
    {
        $admin = request()->user('api');
